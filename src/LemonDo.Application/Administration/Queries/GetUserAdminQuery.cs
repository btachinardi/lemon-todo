...
/// <summary>Handles <see cref="GetUserAdminQuery"/> by fetching a single user with redacted PII.</summary>
public sealed class GetUserAdminQueryHandler(IAdminUserQuery adminUserQuery)
{
    /// <summary>Returns user details with redacted PII, or a not-found error.</summary>
