...
public sealed class GetDefaultBoardQueryHandler(IBoardRepository boardRepository, ITaskRepository taskRepository, ILogger<GetDefaultBoardQueryHandler> logger)
{
    /// <inheritdoc/>
