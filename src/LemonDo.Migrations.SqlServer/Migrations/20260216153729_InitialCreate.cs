        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RedactedSensitiveNote = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    EncryptedSensitiveNote = table.Column<string>(type: "nvarchar(max)", maxLength: 15000, nullable: true),
                    CreatedAt = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: false),
                    UpdatedAt = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    RedactedEmail = table.Column<string>(type: "nvarchar(254)", maxLength: 254, nullable: false),
                    RedactedDisplayName = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    ...
                    EncryptedDisplayName = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: false),
                    EncryptedEmail = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: false),
                    CreatedAt = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: false),
                    UpdatedAt = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NextRank = table.Column<string>(type: "TEXT", nullable: false, defaultValue: "1000"),
