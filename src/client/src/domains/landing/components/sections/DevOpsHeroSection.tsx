        ...
        >
          <div className="rounded-2xl border-2 border-border/40 bg-card/60 p-6 shadow-2xl shadow-primary/5 backdrop-blur-md">
            <div className="mb-4 flex items-center gap-2">
              ...
              <span className="ml-2 text-sm text-muted-foreground">deploy pipeline</span>
            </div>
            <div className="space-y-2 font-mono text-sm leading-relaxed sm:text-base">
              ...
              <p>
                ...
                <span className="text-foreground/60">403 passed (SQLite)</span>
              </p>
              <p>
                <span className="text-success-foreground">✓</span>{' '}
                <span className="text-muted-foreground">backend-test-sql</span>{' '}
                <span className="text-foreground/60">403 passed (SQL Server)</span>
              </p>
              <p>
                <span className="text-success-foreground">✓</span>{' '}
                <span className="text-muted-foreground">frontend-test</span>{' '}
                <span className="text-foreground/60">539 passed + lint clean</span>
              </p>
              <p>
                <span className="text-success-foreground">✓</span>{' '}
