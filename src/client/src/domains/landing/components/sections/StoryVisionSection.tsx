...
const icons = [FileTextIcon, SearchIcon, UsersIcon, NetworkIcon, BookOpenIcon];
...
/** Planning artifacts section — 5 documents written before code. */
      ...
      <div className="mx-auto max-w-7xl">
        ...
        >
          <SectionHeading
            ...
            subtitle={t('story.vision.subtitle')}
            highlight={t('story.vision.highlight')}
          />
        </motion.div>
